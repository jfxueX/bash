...
Do not fret! It is not your fault you don't understand
sed. I will cover 
sed completely.
...
This demonstrates the pattern space
...
One way to do this is to see if the line has the pattern.
...
The above example is not terribly useful as the "xargs" use of echo does not retain the ability to
...
That is, it would mistakenly change '/usr/local/bin'  to '/bin' and not delete '/usr/local'  which was the intention of the programmer.
...
However, this won't work if '/usr/local' is at the beginning, or at the end of the line. It also won't work if '/usr/local' is the only path on the line.
...
But what happens if the string is surrounded by other characters, which may be one of several possible characters?
You can always make up your own class of characters that define the 'end of a word';
For instance, if your string consists of alphanumeric characters and the slash, the class of characters can be defined by '&#91;a-zA-Z0-9/&#93;' or the more flexible '&#91;&#91;:alnum:&#93;/&#93;'.
We can define the class fo characters to be all but these, by using the caret, i.e. '&#91;&#94;&#91;:alnum:&#93;/&#93;'.
And unlike the space before, if you are going to use character classes, you may have to remember what these characters are and not delete them.
...
This method always works, but it is inelegant and error prone.
There are other methods, but they may not be portable.
Solaris's version of sed used the special characters &lsquo;\<&rsquo; and &lsquo;\>&rsquo; as anchors that indicated a word boundary. So you could use
...
[here.](http://www.grymoire.com/Unix/index.html)
